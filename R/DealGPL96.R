...
#'
#' @param file a file name specified by either a variable of mode character, or a double-quoted string, which is of 'GSE*_RAW.tar' which is of platform GPL96.
...
#' }
DealGPL96 <- function(file, type = "probeIDAndGeneSymbol") {
